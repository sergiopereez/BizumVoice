...
const ModelDropdown: React.FC<ModelDropdownProps> = ({
  ...
  return (
    <div className="absolute bottom-full start-0 mb-2 w-64 max-h-[60vh] overflow-y-auto bg-background border border-mid-gray/20 rounded-[20px] shadow-lg py-2 z-50">

      ...
      <div className="flex items-center space-x-1">
        {editingShortcutId === shortcutId ? (
          <div
            ...
            className="px-2 py-1 text-sm font-semibold border border-logo-primary bg-logo-primary/30 rounded-[14px]"
          >
            {formatCurrentKeys()}
          </div>
        ) : (
          <div
            className="px-2 py-1 text-sm font-semibold bg-mid-gray/10 border border-mid-gray/80 hover:bg-logo-primary/10 rounded-[14px] cursor-pointer hover:border-logo-primary"

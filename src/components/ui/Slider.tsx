      ...
      <div className="w-full">
        <div className="flex items-center space-x-1 h-6">
          <input
            ...
            disabled={disabled}
            className="flex-grow h-2 rounded-[20px] appearance-none cursor-pointer focus:outline-none focus:ring-2 focus:ring-logo-primary disabled:opacity-50 disabled:cursor-not-allowed"
            style={{

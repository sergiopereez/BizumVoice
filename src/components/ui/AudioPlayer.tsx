    ...
    <div className={`flex items-center gap-3 ${className}`}>
      ...
      <div className="flex-1 flex items-center gap-2">
        ...
        <input
          ...
          className={`flex-1 h-1 rounded-[20px] appearance-none cursor-pointer focus:outline-none focus:ring-1 focus:ring-logo-primary ${progressPercent >= 99.5 ? "[&::-webkit-slider-thumb]:translate-x-0.5 [&::-moz-range-thumb]:translate-x-0.5" : ""}`}
          style={{
